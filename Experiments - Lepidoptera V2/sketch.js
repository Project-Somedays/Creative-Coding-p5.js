...
function setup() {
  ...
  // COLOURS
  randPalette = random(palettes2).map(e => hexToRgbWithOpacity(e, opacity));

  // SIZE
  // r = 0.025*width;
  r = random(0.0075,0.025)*min(width, height); // Note: 1% of width consistently gave the best butterfly-like results
  D = 2*r;
